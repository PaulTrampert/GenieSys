...
class DataRegisterDirectResult : public AddressingResult {
public:
    DataRegisterDirectResult(GenieSys::M68kCpu* cpu, Bus* bus, uint32_t address, std::vector<uint8_t> data);
...
public:
    ...
    DataRegisterDirectMode(GenieSys::M68kCpu *cpu, Bus *bus);
